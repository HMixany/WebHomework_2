...
class Record:
    def __init__(self, name: str, birthday=None, email=None, address=None):
    ...
    def add_phone(self, number: str) -> str:
        if number is None:
            return
    ...
    def remove_phone(self, number: str) -> str:
